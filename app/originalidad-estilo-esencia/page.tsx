...
export default function OeePage() {
  ...
  return (
    <main className="oee-page">
      ...
      <section className="oee-awards" id="premios" aria-labelledby="premios-title">
        <figure className="oee-awards__photo"><Image src="/oee-awards.png" fill alt="Premios luminosos de OEE con figuras de bailarines" sizes="(max-width: 800px) 100vw, 58vw" /><figcaption>Premios OEE · Fotografía compartida por la marca</figcaption></figure>
        <div className="oee-awards__copy">
          <Image className="oee-awards__logo" src="/oee-logo-copper.png" width={240} height={240} alt="Original Style Essence" />
          <p className="eyebrow">Premios OEE</p>
          <h2 id="premios-title">El movimiento también deja huella.</h2>
          <p>Los premios forman parte de la identidad de las competencias OEE. Las categorías, criterios y reconocimientos de cada edición se publicarán cuando la convocatoria final esté confirmada.</p>
          <span className="pending-chip">Categorías por confirmar</span>
        </div>
      </section>
